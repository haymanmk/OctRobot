#!/usr/bin/env python3
"""
gen_test_vectors.py — Ground-truth FK test vector generator.

Uses modern_robotics (Lynch & Park) as the reference implementation.
Reads robot_config.yaml and writes:
  - validation/fk_test_vectors.json          (human-readable ground truth)
  - tests/kinematics/include/fk_test_vectors.h  (embedded in C native tests)
